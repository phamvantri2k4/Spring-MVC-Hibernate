        ...
        <div class="row justify-content-center">
            <div class="col-md-3">
                <div class="card p-3 mb-3">
                    ...
                    <ul class="list-unstyled">
                        <li><img src="${pageContext.request.contextPath}/resources/images/avt.jpg" alt="Avatar" class="rounded-circle me-2" width="30"> @username1</li>
                        <li><img src="${pageContext.request.contextPath}/resources/images/avt.jpg" alt="Avatar" class="rounded-circle me-2" width="30"> @username2</li>
                        <li><img src="${pageContext.request.contextPath}/resources/images/avt.jpg" alt="Avatar" class="rounded-circle me-2" width="30"> @username3</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-6 mt-0">
                ...
                <% User user = (User) request.getAttribute("user"); %>
                    <div class="card-body">
                        <img src="<%= user.getAvatar() != null ? request.getContextPath() + user.getAvatar() : request.getContextPath() + "/resources/images/cfsua.jpg" %>" alt="Avatar" class="rounded-circle mb-3" width="150" height="150">
            ...
            <div class="col-md-3">
                <div class="card p-3 mb-3">
                    ...
                    <p><img src="${pageContext.request.contextPath}/resources/images/avt.jpg" alt="Avatar" class="rounded-circle me-2" width="30"> @username <button class="btn btn-sm btn-primary">Theo dõi</button></p>
                </div>
            </div>
        </div>
    </div>
